...
function Twin(timeArray, valueArray)
{
	this.times  = timeArray || [];
	this.values = valueArray || [];
}

Twin.prototype.lerp = function(t)
{
	var i = 0;
...
function ParticleEngine()
{
	...
	this.colorTween  = new Twin();
	
	this.opacityBase   = 1.0;
	this.opacitySpread = 0.0;
	this.opacityTween  = new Twin();
...
ParticleEngine.prototype.setValues = function( parameters, exist )
{
